...
const 摘要基线 = 632, 正文基线 = 75495, 结论基线 = 1188  // 正文基线2026-08-30十订修订后更新（75208→75493）
...
记('字数', 摘要过 && 正文过 && 结论过,
  `摘要 ${摘要字数}（300-2000）${基线差(摘要字数, 摘要基线)}；正文 ${正文字数}（≥12000）${基线差(正文字数, 正文基线)}；结论 ${结论字数}（400-2000）${基线差(结论字数, 结论基线)}`)
